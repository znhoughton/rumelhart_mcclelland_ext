...
extract_patterns_for_model <- function(model_tag,
  ...
  patterns <- df %>%
    ...
    mutate(
      ...
      prop_items = n_verbs / total_items,   # <<— NEW
...
```{r}
df1 = read_csv('../Data/sae_latents_long/L3_H256_SAE@final_K5.csv')
df2 = read_csv('../Data/sae_latents_long/L3_H256_SAE@final_K15.csv')
df3 = read_csv('../Data/sae_latents_long/L3_H256_SAE@final_K20.csv')
